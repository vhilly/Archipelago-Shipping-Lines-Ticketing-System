  ...
  class Passenger extends CActiveRecord
  {
    ...
    public function rules()
    {
      ...
      return array(
        ...
        array('first_name, last_name, email, contact, middle_name, nationality,birth_date', 'length', 'max'=>100),
        array('prefix', 'length', 'max'=>5),
        array('gender, civil_status', 'length', 'max'=>1),
        array('address', 'length', 'max'=>255),
        // The following rule is used by search().
        // Please remove those attributes that should not be searched.
        array('id, first_name, last_name, email, contact, middle_name,birth_date, prefix, gender, civil_status, nationality, address', 'safe', 'on'=>'search'),
      );
    }
