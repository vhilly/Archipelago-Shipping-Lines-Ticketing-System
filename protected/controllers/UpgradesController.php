...
$model->attributes=$_POST['Upgrades'];
if($model->save()){
    Yii::app()->user->setFlash('success', 'Seat Upgrade Payment has been updated!');
    $this->redirect(array('admin'));
}
}
...
{
$dataProvider=new CActiveDataProvider('Upgrades');
...
{
$model=Upgrades::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='upgrades-form')
{
