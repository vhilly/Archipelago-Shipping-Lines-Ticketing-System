...
return $model;
  ...
  public function actionSetup(){
   $class = new CargoClass;
   $rates = new CargoFareRates;

   $ratesTable=new CargoFareRates('search');
   $ratesTable->unsetAttributes();  // clear any default values
   if(isset($_GET['CargoFareRates'])){
     $ratesTable->attributes=$_GET['CargoFareRates'];
   }

   $classTable=new CargoClass('search');
   $classTable->unsetAttributes();  // clear any default values
   if(isset($_GET['CargoClass'])){
     $classTable->attributes=$_GET['CargoClass'];
   }
