...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
  ...
  <?php echo $form->hiddenField($model,'voyage')?>
<?php
?>
<table>
  <tr>
    <td>SELECT VOYAGE:</td>
    <td><?php echo $form->dropDownList($model,'voyage',CHtml::listData(Voyage::model()->findAll(array('condition'=>'status<3','params'=>array(':id'=>$model->voyage))),'id','name'),array('class'=>'voyage seatChange','disabled'=> $ref=='cIN'? true:''))?></td>
    <td>Seat:</td>
