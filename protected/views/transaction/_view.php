<div class="view">
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('ovamount')); ?>:</b>
	<?php echo CHtml::encode($data->ovamount); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('ovdiscount')); ?>:</b>
	<?php echo CHtml::encode($data->ovdiscount); ?>
	<br />
