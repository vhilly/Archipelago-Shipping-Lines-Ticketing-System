...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'columns'=>array(
        ...
        array('name'=>'departure_time', 'header'=>'Departure Time','value'=>'date("g:i A",strtotime($data->departure_time))'),
        array('name'=>'arrival_time', 'header'=>'Arrival Time','value'=>'date("g:i A",strtotime($data->arrival_time))'),
    ),
